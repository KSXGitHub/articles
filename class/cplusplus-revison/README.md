...
# Giải đề cương ôn tập C++

Đây là tập hợp một vài chương trình C++ có trong [đề cương](./questions.pdf), mình thích câu nào thì mình làm câu đấy
...
Các chương trình được viết trong này không dành cho Turbo C++ (mà dành cho GCC/Clang/MSVS) nhưng các bạn có thể sửa để phù hợp
 - Lấy [câu 30](./codes/questions-30.cpp) làm ví dụ.
